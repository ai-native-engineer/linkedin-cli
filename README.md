...
AI-native LinkedIn CLI for personal workflows.
...
This repository ships project-local skills:
...
It also includes a Claude plugin manifest at [`.claude-plugin/plugin.json`](./.claude-plugin/plugin.json).
